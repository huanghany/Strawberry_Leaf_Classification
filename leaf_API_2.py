...
class LeafClassifier:
    def __init__(self, model_path, input_folder, output_folder,
                 H_min=38, H_max=59, S_min=105, S_max=165, iou=0.85, conf=0.4):
        """
        初始化叶片分类器。
        ...
        self.lower_green = np.array([35, 40, 40])  # 绿色的HSV下限
        self.upper_green = np.array([85, 255, 255])  # 绿色的HSV上限
...
if __name__ == '__main__':
    ...
    # 示例：处理单张图片
    single_image_path = r'test_pic/test_aiwei/4.jpg'
    classifier.process_single_image(single_image_path, '4.jpg')  # 处理单张图片
